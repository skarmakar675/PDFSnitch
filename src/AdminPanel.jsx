...
function AdsensePage() {
  ...
  return <div>
    ...
    {tab === 'documentation' ? <section className="admin-card"><h2>AdSense-safe notes</h2><p>Keep ads away from upload, compress, progress, error and download areas. Never ask users to click ads. Do not track ad clicks. Use real AdSense only on your approved live domain.</p></section> : null}
  </div>
}
...
function DocumentationPage() {
  const docs = [
    ...
    ['How to setup AdSense', 'Open AdSense Monetization, enter Publisher ID, enable monetization, choose Auto/Manual/Hybrid, then configure ads.txt on your live domain.'],
    ...
    ['Troubleshoot backend not reachable', 'Open the Render backend health URL, confirm /api/health returns ok, then use the Backend/API Test connection button.'],
  ]
