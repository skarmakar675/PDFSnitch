...
PDFSNITCH_PUBLIC_API_BASE_URL=https://pdfsnitch-izhk.onrender.com
...
```text
https://pdfsnitch-izhk.onrender.com/api/health
```
...
```env
VITE_API_URL=https://pdfsnitch-izhk.onrender.com
```
...
- `vercel.json` rewrites `/ads.txt` to `https://pdfsnitch-izhk.onrender.com/ads.txt`.
...
```text
API Base URL: https://pdfsnitch-izhk.onrender.com
